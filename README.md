# The Dodechedron (sic) of Fortune
## The Book
...
The book appears to be an early modern parlor game. Its 144 questions are sorted into twelve astrological “houses,” and a twelve-sided die or D12 -- a dodecahedron, hence the title -- is cast to carry you from your question to one of twelve possible verse answers, for 1,728 possible fortunes in all.
...
- A page-image scan of the 1613 English edition via Google Books, the original inspiration for the app, and used as the source for transcription.
- The Early English Books Online Text Creation Partnership (EEBO-TCP) edition, used to check and correct the transcription.
